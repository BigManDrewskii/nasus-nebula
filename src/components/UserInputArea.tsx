...
// ── Curated fallback model list (used when no OR models fetched yet) ──────────
// Keep this in sync with FALLBACK_MODELS in SettingsPanel.tsx
const STATIC_MODELS = [
  // Anthropic
...
function ModelDropdown({
  ...
  const displayLabel = selected?.label ?? shortLabel(value)
