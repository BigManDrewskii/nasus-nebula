...
import {
  require_jsx_runtime
} from "./chunk-NIUX4ESI.js";
import {
  require_react
} from "./chunk-NRASL5SK.js";
import {
  __toESM,
  require_dist,
  require_dist2,
  require_dist3
} from "./chunk-JAA6DWTU.js";
...
var zt = /\b(?:position|zIndex|opacity|transform|webkitTransform|mixBlendMode|filter|webkitFilter|isolation)\b/;
function bt(e) {
...
function Tt({
  ...
  }), h = ye(r), v = (0, import_react.useRef)(null), [x, y] = Dt(), p = (0, import_react.useRef)({
...
function Nt(e, t) {
  const { id: n } = xe(), o = (0, import_react.useRef)({
    collapse: fe,
    expand: fe,
    getSize: () => ({
      asPercentage: 0,
...
function _t({
  ...
  const m = !!r, d = ye(r), f = ve({
    disabled: s
  }), h = (0, import_react.useRef)(null), v = Se(h, l), {
    getPanelStyles: x,
    id: y,
    orientation: p,
    registerPanel: w,
...
function Ht({
  ...
  const r = ye(i), a = ve({
    disabled: n
  }), [u, c] = (0, import_react.useState)({}), [g, b] = (0, import_react.useState)("inactive"), S = (0, import_react.useRef)(null), m = Se(S, o), {
    disableCursor: d,
    id: f,
    orientation: h,
    registerSeparator: v,
